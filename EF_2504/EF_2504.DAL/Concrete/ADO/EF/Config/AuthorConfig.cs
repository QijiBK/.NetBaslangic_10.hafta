...
namespace EF_2504.DAL.Concrete.ADO.EF.Config
{
    public class AuthorConfig : IEntityTypeConfiguration<Author>
    {
        public void Configure(EntityTypeBuilder<Author> builder)
        {
            ...
            builder.HasData(
                new Author { AuthorId = 1,AuthorFirstName ="Burak",AuthorLastName="Korkmaz"},
                new Author { AuthorId = 2,AuthorFirstName ="Ali",AuthorLastName="Dal"},
                new Author { AuthorId = 3,AuthorFirstName ="İsmail",AuthorLastName="Sesiçok"}
                );
