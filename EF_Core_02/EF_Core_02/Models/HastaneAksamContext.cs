...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-8M7D7GE\\SQLEXPRESS;Database=HastaneAksam;User=sa;Password=123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bolumler>(entity =>
            {
                ...
                entity.HasIndex(e => e.BolumAd, "UQ__Bolumler__7BD2881B6DBAFB70")
                    .IsUnique();
            ...
            modelBuilder.Entity<Doktorlar>(entity =>
            {
                ...
                entity.HasIndex(e => e.SicilNo, "UQ__Doktorla__B736D3C2A998FA28")
                    .IsUnique();
            ...
            modelBuilder.Entity<Hastalar>(entity =>
            {
                ...
                entity.HasIndex(e => e.TcNo, "UQ__Hastalar__8EF935A6AB2712C0")
                    .IsUnique();
